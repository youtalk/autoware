...
graph TD
    subgraph "ハードリアルタイム [1-10ms]"
        HRT_AEB[自動緊急ブレーキ<br/>WCET: 5ms]
        HRT_STEER[操舵制御<br/>WCET: 8ms]
        HRT_BRAKE[ブレーキ制御<br/>WCET: 6ms]
        HRT_SAFETY[安全監視<br/>WCET: 3ms]
    end
    
    subgraph "ファームリアルタイム [10-50ms]"
        FRT_DETECT[物体検出<br/>WCET: 30ms]
        FRT_TRACK[物体追跡<br/>WCET: 25ms]
        FRT_FUSION[センサー融合<br/>WCET: 20ms]
        FRT_LOC[自己位置推定<br/>WCET: 35ms]
    end
    
    subgraph "ソフトリアルタイム [50-200ms]"
        SRT_PLAN[経路計画<br/>平均: 100ms]
        SRT_E2E[E2E推論<br/>平均: 80ms]
        SRT_MAP[地図更新<br/>平均: 150ms]
        SRT_PRED[軌道予測<br/>平均: 120ms]
    end
